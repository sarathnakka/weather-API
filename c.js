var state_arr = ["andhra pradesh", "hyderabad", "punjab", "arunachal pradesh", "assam", "bihar", "chhattisgarh", "goa", "gujarat", "haryana", "himachal pradesh", "jharkhand", "karnataka", "kerala", "madhya pradesh", "maharashtra", "manipur", "meghalaya", "mizoram", "nagaland", "odisha", "rajasthan", "sikkim", "tamil nadu", "tripura", "uttar pradesh", "uttarakhand", "west bengal"];
var s_a = ["vijayawada", "nizamabad", "chattisgarh", "bomdila", "guwahati", "patna", "raipur", "vasco da gama", "ahmedabad", "faridabad", "shimla", "jamshedpur", "bangalore", "thiruvananthapuram", "indore", "mumbai", "imphal", "umsning", "aizawl", "mokokchung", "bhubaneswar", "jodhpur", "Gangtok", "Chennai", "Agartala", "Lucknow", "Dehradun", "Kolkata"];
var s_a1 = ["guntur", "warangal", "jalandhar", "itanagar", "silchar", "gaya", "bhilai", "calangute", "surat", "gurugram", "kullu", "dhanbad", "hubli-dharwad", "kollam", "bhopal", "puna", "bishnupur", "tura", "serchhip", "wokha", "cuttack", "udaipur", "Soreng", "Tiruchirapalli", "Dharmanagar", "Agra", "Haridwar", "Asansol"];
var s_a2 = ["machilipatnam", "khammam", "amritsar", "rupa", "dibrugarh", "purnia", "bilaspur", "panaji", "vadodara", "panipat", "manali", "ranchi", "mysore", "kochi", "jabalpur", "nagpur", "moirang", "mawphlang", "lunglei", "zunheboto", "rourkela", "jaipur", "Mangan", "Madurai", "Udaipur", "Varanasi", "Roorkee", "Durgapur"];
